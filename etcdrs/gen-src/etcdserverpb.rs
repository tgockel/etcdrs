...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub(crate) struct DowngradeVersionTestRequest {
    #[prost(string, tag = "1")]
    pub(crate) ver: ::prost::alloc::string::String,
}
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
...
pub(crate) struct StatusResponse {
    ...
    pub(crate) downgrade_info: ::core::option::Option<DowngradeInfo>,
}
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub(crate) struct DowngradeInfo {
    #[prost(bool, tag = "1")]
    pub(crate) enabled: bool,
    #[prost(string, tag = "2")]
    pub(crate) target_version: ::prost::alloc::string::String,
}
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
...
pub(crate) mod kv_server {
    ...
    use tonic::codegen::*;
    #[async_trait]
    pub(crate) trait Kv: std::marker::Send + std::marker::Sync + 'static {
        async fn range(
    ...
    pub(crate) const SERVICE_NAME: &str = "etcdserverpb.KV";
...
pub(crate) mod watch_server {
    ...
    use tonic::codegen::*;
    #[async_trait]
    pub(crate) trait Watch: std::marker::Send + std::marker::Sync + 'static {
        async fn watch(
            self: std::sync::Arc<Self>,
    ...
    #[derive(Debug)]
    pub(crate) struct WatchServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    pub(crate) const SERVICE_NAME: &str = "etcdserverpb.Watch";
...
pub(crate) mod lease_server {
    ...
    use tonic::codegen::*;
    #[async_trait]
    pub(crate) trait Lease: std::marker::Send + std::marker::Sync + 'static {
    ...
    #[derive(Debug)]
    pub(crate) struct LeaseServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    pub(crate) const SERVICE_NAME: &str = "etcdserverpb.Lease";
...
pub(crate) mod cluster_server {
    ...
    use tonic::codegen::*;
    #[async_trait]
    pub(crate) trait Cluster: std::marker::Send + std::marker::Sync + 'static {
        async fn member_add(
            self: std::sync::Arc<Self>,
    ...
    #[derive(Debug)]
    pub(crate) struct ClusterServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    pub(crate) const SERVICE_NAME: &str = "etcdserverpb.Cluster";
...
pub(crate) mod maintenance_server {
    ...
    use tonic::codegen::*;
    #[async_trait]
    pub(crate) trait Maintenance: std::marker::Send + std::marker::Sync + 'static {
        async fn alarm(
            self: std::sync::Arc<Self>,
    ...
    #[derive(Debug)]
    pub(crate) struct MaintenanceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    pub(crate) const SERVICE_NAME: &str = "etcdserverpb.Maintenance";
...
pub(crate) mod auth_server {
    ...
    use tonic::codegen::*;
    #[async_trait]
    pub(crate) trait Auth: std::marker::Send + std::marker::Sync + 'static {
    ...
    pub(crate) const SERVICE_NAME: &str = "etcdserverpb.Auth";
